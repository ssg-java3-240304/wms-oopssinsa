...
ALTER TABLE `ob_detail` ADD CONSTRAINT `FK_ob_request_TO_ob_detail_1` FOREIGN KEY (
	`ob_id`
)
...
ALTER TABLE `ob_detail` ADD CONSTRAINT `FK_ob_request_TO_ob_detail_2` FOREIGN KEY (
	`product_id`
)
REFERENCES `ob_request` (
	`product_id`
...
ALTER TABLE `worker` ADD CONSTRAINT `FK_account_TO_worker_1` FOREIGN KEY (
	`id`
)
REFERENCES `account` (
	`id`
