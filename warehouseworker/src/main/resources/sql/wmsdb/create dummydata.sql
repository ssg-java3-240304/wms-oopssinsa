...
insert into ib_worker (ib_id, manufacture_date, product_id, worker_id)
VALUES (2240521, 240516, 'TS001', 'worker1'),
       (2240521, 240517, 'TS001', 'worker2'),
       (3240521, 240510, 'JK002', 'worker3');
...
values (230721, 3240521, 'JK003', 'worker2');
...
SET foreign_key_checks = 0; -- -> 일시적으로 외래키 설정 해제함
SET foreign_key_checks = 1;

insert into ob_request (id, product_id, login_id, quantity, recipient_name, address)
VALUES (3240521, 'JK003', 'user03', 1, '김나경', '평택시');

insert into ob_request (id, product_id, login_id, quantity, recipient_name, address)
VALUES (1240521, 'SH001', 'user01', 1, '정예진', '동작구'),
       (4240521, 'BG003', 'user04', 1, '이영우', '관악구');

insert into ob_detail (manufacture_date, ob_id, product_id, quantity, status, completion_date, tracking_number)
VALUES (240521, 1240521, 'SH001', 1, 'P', null, null),
       (230823, 4240521, 'BG003', 1, 'P', null, null);

# insert into ob_worker (manufacture_date, ob_id, product_id, worker_id, location_id)
# VALUES (240521, 1240521, 'SH001', 'worker1', (select id
#                                               from sub_location
#                                               where (section_id, category_id) =
#                                                     (select s.id, p.category_id
#                                                      from product p
#                                                               left join section s on (s.brand_id = p.brand_id)
#                                                      where p.id ='SH001'))),
#        (230823, 4240521, 'BG003', 'worker3', (select id
#                                               from sub_location
#                                               where (section_id, category_id) =
#                                                     (select s.id, p.category_id
#                                                      from product p
...
insert into ob_worker (manufacture_date, ob_id, product_id, worker_id)
VALUES (240521, 1240521, 'SH001', 'worker1'),
       (230823, 4240521, 'BG003', 'worker3');
